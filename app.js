...
const translations = {
    RU: {
        ...
        'dock.hero': '3D Cube Hero',
        'dock.projects': '2.5D Проекты',
        'dock.bot': 'AI Bot Demo',
        'dock.terminal': 'CLI Терминал',
        'dock.cv': 'Скачать CV (PDF)',
        'dock.contact': 'Telegram @Easyvaleriy',
        'hero.role': 'AI Solutions Engineer & Architect',
        'hero.desc': 'Я разрабатываю полносистемные ИИ-сервисы, CRM-платформы (React + Supabase RLS), n8n-пайплайны и серверную инфраструктуру в 3x быстрее.',
        'hero.cta': '<i class="ph ph-paper-plane-tilt text-base"></i> Связаться в Telegram',
        'hero.github': '<i class="ph ph-github-logo text-base"></i> GitHub @Valerador',
        'story.headline': 'Shaping the Future <br><span class="font-serif italic font-normal text-purple-300">Through Design, Technology, and Bold Ideas.</span>',
        'story.paragraph': 'Более 8 лет разработки для веба — стартапы, агентства и бренды. От интерактивных лендингов до сложнейших 3D веб-систем.',
        'orbit.badge': '3D Container Scroll Perspective',
        'orbit.title': 'Unleash the Power of <br><span class="text-3xl sm:text-5xl bg-gradient-to-r from-brandPurple via-purple-300 to-emerald-300 bg-clip-text text-transparent font-extrabold">AI Systems & Architecture</span>',
        ...
        'bot.badge': 'Live Interactive Simulation',
        'bot.title': 'Демо ИИ-Бота (Telepilot + n8n + RAG)',
        'bot.sub': 'Проверь работу агента — нажми на одну из кнопок ниже.',
        'bot.reset': 'Сбросить',
        'bot.welcome': 'Здравствуйте! Я ИИ-ассистент записи. Я подключен к СУБД и Google Календарям. Чем могу помочь?',
        'bot.b1': '💬 "Хочу записаться на завтра"',
        'bot.b2': '📅 "Свободные слоты на вечер?"',
        'bot.b3': '⚡ "Подтвердить запись на 18:00"',
        'term.title': 'Консоль Навыков (Antigravity CLI)',
        ...
        'contact.badge': 'Open for New Projects & Contracts',
        'contact.title': 'Давайте создадим ваш ИИ-проект',
        'contact.sub': 'Нужен умный Telegram-бот с RAG, автоматизация n8n, CRM на React/Supabase или защищённая серверная инфраструктура? Напишите мне прямо сейчас.',
    ...
    EN: {
        'intro.text': 'Where intelligence meets code.',
        'dock.hero': '3D Cube Hero',
        'dock.projects': '2.5D Projects',
        'dock.bot': 'AI Bot Demo',
        'dock.terminal': 'CLI Terminal',
        'dock.cv': 'Download CV (PDF)',
        'dock.contact': 'Telegram @Easyvaleriy',
        'hero.role': 'AI Solutions Engineer & Systems Architect',
        'hero.desc': 'I architect full-stack AI services, commercial CRM platforms (React + Supabase RLS), n8n workflows, and Linux infrastructure 3x faster.',
        'hero.cta': '<i class="ph ph-paper-plane-tilt text-base"></i> Contact on Telegram',
        'hero.github': '<i class="ph ph-github-logo text-base"></i> GitHub @Valerador',
        'story.headline': 'Shaping the Future <br><span class="font-serif italic font-normal text-purple-300">Through Design, Technology, and Bold Ideas.</span>',
        'story.paragraph': 'Over 8 years building for the web — across startups, agencies, and global brands. From landing pages to high-end 3D web experiences.',
        'orbit.badge': '3D Container Scroll Perspective',
        'orbit.title': 'Unleash the Power of <br><span class="text-3xl sm:text-5xl bg-gradient-to-r from-brandPurple via-purple-300 to-emerald-300 bg-clip-text text-transparent font-extrabold">AI Systems & Architecture</span>',
        ...
        'bot.badge': 'Live Interactive Simulation',
        'bot.title': 'AI Agent Demo (Telepilot + n8n + RAG)',
        'bot.sub': 'Test live bot responses — click any scenario button below.',
        'bot.reset': 'Reset',
        ...
        'term.title': 'Skills Terminal (Antigravity CLI)',
        ...
        'contact.badge': 'Open for New Projects & Contracts',
        'contact.title': "Let's Build Your AI System",
        'contact.sub': 'Need an intelligent Telegram bot with RAG, n8n automation, React/Supabase CRM, or hardened server infrastructure? Get in touch today.',
